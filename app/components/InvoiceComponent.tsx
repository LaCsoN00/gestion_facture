...
const InvoiceComponent: React.FC<InvoiceComponentProps> = ({ invoice, index: _index }) => {
            ...
            <div className='w-full'>
                <div>
                    <div className='stat-title'>
                        <div className='uppercase text-sm'>FACT-{invoice.id} (#{_index + 1})</div> {/* Affiche l'index ici */}
                    </div>
                    <div>
